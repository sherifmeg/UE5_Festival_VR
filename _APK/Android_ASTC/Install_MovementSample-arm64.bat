...
if "%ANDROIDHOME%"=="" set ANDROIDHOME=C:/Users/delld/AppData/Local/Android/Sdk
...
%ADB% %DEVICE% shell rm -r %STORAGE%/Download/obb/com.epicgames.festival
...
%ADB% %DEVICE% shell pm grant com.epicgames.festival android.permission.READ_EXTERNAL_STORAGE >nul 2>&1
%ADB% %DEVICE% shell pm grant com.epicgames.festival android.permission.WRITE_EXTERNAL_STORAGE >nul 2>&1
